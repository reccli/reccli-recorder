    ...
    <div className="min-h-screen bg-gradient-to-br from-[#5b6ef7] to-[#6b5bb8] text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 md:px-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="mb-4 bg-blue-500/20 w-14 h-14 rounded-xl flex items-center justify-center">
                <FolderTree className="w-7 h-7 text-blue-400" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">load_project_context</h3>
              <p className="opacity-90">Loads project features, folder tree, and last session summary. Called automatically at session start.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="mb-4 bg-green-500/20 w-14 h-14 rounded-xl flex items-center justify-center">
                <Zap className="w-7 h-7 text-green-400" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">project_init</h3>
              <p className="opacity-90">Scans your codebase with Tree-sitter, clusters files into features, creates a structured project map.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="mb-4 bg-purple-500/20 w-14 h-14 rounded-xl flex items-center justify-center">
                <Search className="w-7 h-7 text-purple-400" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">search_history</h3>
              <p className="opacity-90">Hybrid search across all past sessions. "What did we decide about auth?" — answered instantly.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="mb-4 bg-orange-500/20 w-14 h-14 rounded-xl flex items-center justify-center">
                <GitBranch className="w-7 h-7 text-orange-400" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">expand_search_result</h3>
              <p className="opacity-90">Drill into a search result to see the full conversation context — exact reasoning, not just summaries.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="mb-4 bg-red-500/20 w-14 h-14 rounded-xl flex items-center justify-center">
                <Save className="w-7 h-7 text-red-400" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">save_session_notes</h3>
              <p className="opacity-90">Persist decisions, problems solved, and next steps. The next session picks up where you left off.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 flex flex-col items-center justify-center text-center">
              <div className="mb-4 bg-white/10 w-14 h-14 rounded-xl flex items-center justify-center">
                <Brain className="w-7 h-7 text-white/60" strokeWidth={2} />
              </div>
              <h3 className="text-xl font-bold mb-2">Open format</h3>
              <p className="opacity-90">.devsession and .devproject are open specs (CC0). Your memory, your data, no lock-in.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 relative overflow-hidden">
              ...
              <ul className="space-y-3 mb-8 text-lg">
                <li className="flex items-start gap-2">
                  ...
                  <span>MCP server for Claude Code, Cursor, Windsurf</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">&#10003;</span>
                  <span>Project init with Tree-sitter codebase scan</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">&#10003;</span>
                  <span>Cross-session memory and search</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">&#10003;</span>
                  <span>Hybrid retrieval (dense + BM25)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">&#10003;</span>
                  <span>Open .devsession and .devproject formats</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">&#10003;</span>
                  <span>Local storage — your data stays yours</span>
                </li>
              </ul>
              <a
                href="#get-started"
              ...
              {!showWaitlistForm ? (
                <>
                  <ul className="space-y-3 mb-8 text-lg">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">&#10003;</span>
                      <span>Shared .devsession history across team</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">&#10003;</span>
                      <span>Cross-developer session search</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">&#10003;</span>
                      <span>Team project dashboard</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">&#10003;</span>
                      <span>Hosted memory storage</span>
                    </li>
                  </ul>
                  <button
      ...
      <footer className="py-12 border-t border-white/20">
        <div className="container mx-auto px-10 max-w-7xl text-center">
          <p className="text-white/80 mb-4">&copy; 2024-{new Date().getFullYear()} reccli. Open source memory for AI agents.</p>
